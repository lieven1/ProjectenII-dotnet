...
namespace Taijitan.Models.Domain
{
    public class DomeinController
    {
        ...
        public DomeinController()
        {
            ...
            _leden = new List<Lid>() {
                new Lid("user1", "LastName1", "FirstName1", new DateTime(1998,01,01), "052525252", "email1@email.be", new Adres("Belgium", "9000", "Gent", "Straat", "1")),
                new Lid("user2", "LastName2", "FirstName2", new DateTime(1998,05,15), "052525252", "email1@email.be", new Adres("Belgium", "9000", "Gent", "Straat", "1")),
                new Lid("user3", "LastName3", "FirstName3", new DateTime(1998,03,12), "052525252", "email1@email.be", new Adres("Belgium", "9000", "Gent", "Straat", "1")),
                new Lid("user4", "LastName4", "FirstName4", new DateTime(1998,07,12), "052525252", "email1@email.be", new Adres("Belgium", "9000", "Gent", "Straat", "1")),
                new Lid("user5", "LastName5", "FirstName5", new DateTime(1998,05,11), "052525252", "email1@email.be", new Adres("Belgium", "9000", "Gent", "Straat", "1"))};
